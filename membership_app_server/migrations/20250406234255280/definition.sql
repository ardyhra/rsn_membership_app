...
--
-- Class Broadcast as table broadcast
--
...
--
-- Class DatabaseMember as table database_member
--
...
--
-- Class Informasi as table informasi
--
...
--
-- Class SessionToken as table session_token
--
...
-- Indexes
CREATE UNIQUE INDEX "session_token_token_hash_idx" ON "session_token" USING btree ("tokenHash");
CREATE INDEX "session_token_user_id_idx" ON "session_token" USING btree ("userId");
CREATE INDEX "session_token_expires_at_idx" ON "session_token" USING btree ("expiresAt");
...
--
-- Foreign relations for "database_member" table
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('membership_app', '20250406234255280', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20250406234255280', "timestamp" = now();
